...
{
    public class BoundedTextInstance : IDrawableTextResource
    {
        ...
        public BoundedTextInstance(IAssetWrapper<IFontResource> font)
        {
            _wrappedFont = font;
        }
        ...
        private Vector2 GetOriginInternal()
        {
            switch (OriginPlacement)
            {
                ...
                case OriginPlacement.BottomRight:
                    return _wrappedFont.Value.MeasureString(_text);
                default:
