...
{
    [JsonConverter(typeof(StaticBasedOnDamageDonePayloadModifierFactoryJsonConverter))]
    public class StaticBasedOnDamageDonePayloadModifierFactory : ModifierFactory
    {
        public StaticBasedOnDamageDonePayloadModifierFactory(
    ...
    public class StaticBasedOnDamageDonePayloadModifierFactoryJsonConverter : JsonConverter<StaticBasedOnDamageDonePayloadModifierFactory>
    {
        public override StaticBasedOnDamageDonePayloadModifierFactory Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            return new StaticBasedOnDamageDonePayloadModifierFactory(triggerStyle.Value, modStyle, portionOfDamageAsStatMod.Value, duration, durationStyle.Value, modifierAlignment.Value, isModifierVisible.Value, modifierIconKey, friendlyName, description, mergeKey);
        }

        public override void Write(Utf8JsonWriter writer, StaticBasedOnDamageDonePayloadModifierFactory value, JsonSerializerOptions options)
        {
